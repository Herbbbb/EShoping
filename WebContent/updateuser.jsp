...
<!--aside nav-->
<!--aside nav-->
<form id="form1" method="post" action="updateuserload" enctype="application/x-www-form-urlencoded" >
 ...
 <div class="rt_content">
      ...
      <ul class="ulColumn2">
       ...
       <li>
        ...
        <input type="text" class="textbox textbox_225" value="${user.userName }" placeholder="真实姓名..." id="userName" name="userName"/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">登陆密码：</span>
        <input type="password" class="textbox textbox_225" value="${user.login.password }" placeholder="登陆密码..." id="password" name="password"/>
       </li>
       <li>
        <span class="item_name" style="width:120px;" >确认密码：</span>
        <input type="password" class="textbox textbox_225" value="${user.login.password }" placeholder="确认密码..." id="confirm" name="confirm"/>
       </li>
       ...
       <li>
        ...
        <input type="text" class="textbox textbox_295" name="city" value="${user.city }" placeholder="详细地址..."/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">收货地址：</span>
        <input type="text" class="textbox textbox_295" name="address" value="${user.address }" placeholder="详细地址..."/>
       </li>
       
        <li>
        <span class="item_name" style="width:120px;">手机号码：</span>
        <input type="tel" class="textbox textbox_225" name="tel" value="${user.tel }" placeholder="手机号码..."/>
       </li>
