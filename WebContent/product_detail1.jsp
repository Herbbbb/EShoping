     ...
     <section>
      <ul class="ulColumn2">
       <li>
        ...
        <input type="text" class="textbox textbox_295" placeholder="商品名称...只读模式" readonly="readonly"/>
       </li>
       ...
       <li>
        ...
        <script id="editor" type="text/plain" style="width:1024px;height:400px;margin-left:120px;margin-top:0;"></script>
           <!--ueditor可删除下列信息-->
